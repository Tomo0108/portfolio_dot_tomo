              ...
              <div className="mt-8 bg-muted/50 rounded-xl p-8 space-y-8">
                <div>
                  <h1 className="text-3xl font-bold font-heading mb-4">
                    <span className="bg-white dark:bg-white px-3 py-1.5 rounded inline-block text-black">{item.title}</span>
                  </h1>
                ...
                <div className="space-y-6">
                  <div>
                    <h2 className="text-xl font-bold font-heading mb-4 text-foreground/80">Tools</h2>
