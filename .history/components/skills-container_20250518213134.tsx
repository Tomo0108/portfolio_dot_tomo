                          ...
                          <AccordionContent className="p-4 pt-0">
                            {example.achievements && example.achievements.length > 0 ? (
                              <div className="pt-2 pb-4">
                                <p className="text-sm font-semibold text-foreground/90 mb-2">AIを活用した業務改善ツール開発の成果:</p>
                                <Table>
                                  <TableHeader>
                                    <TableRow>
                                      <TableHead className="w-[70%]">自動化項目</TableHead>
                                      <TableHead className="text-right">削減時間</TableHead>
                                    </TableRow>
                                  </TableHeader>
                                  <TableBody>
                                    {example.achievements.map((achievement, index) => (
                                      <TableRow key={index}>
                                        <TableCell className="font-medium">{achievement.item}</TableCell>
                                        <TableCell className="text-right">{achievement.reductionTime}</TableCell>
                                      </TableRow>
                                    ))}
                                  </TableBody>
                                </Table>
