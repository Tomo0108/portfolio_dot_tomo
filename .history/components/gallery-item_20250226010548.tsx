              ...
              <div className="space-y-8">
                ...
                <div className="bg-muted/50 rounded-xl p-8 space-y-8">
                  ...
                  <div className="space-y-6">
                    <div>
                      <h2 className="text-xl font-bold font-heading mb-4 text-foreground/80">作業工程</h2>
                      ...
                      <div className="mt-4 p-4 bg-background/50 rounded-lg">
                        <p className="text-muted-foreground/90 text-sm leading-relaxed">{imageTypes[selectedTab].description}</p>
                      </div>
                    </div>
