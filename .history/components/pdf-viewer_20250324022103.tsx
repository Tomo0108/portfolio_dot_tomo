  ...
  return (
    <div className="relative w-full max-w-5xl mx-auto px-4">
      <div className="relative h-screen max-h-[80vh] min-h-[500px] md:min-h-[700px] w-full">
        <iframe
          src={`${pdfUrl}#zoom=page-fit&pagemode=none`}
          ...
          title="PDF Viewer"
        />
        <div className="absolute inset-0 flex items-center justify-center bg-background/95 rounded-lg md:opacity-0 md:hover:opacity-100 transition-opacity">
          <a
            href={pdfUrl}
            target="_blank"
