...
export function RotatingNav() {
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-30 hover:opacity-100 transition-opacity duration-300 z-10">
      <div 
        className="w-[280px] h-[280px] relative hover:[&~.hero-text]:opacity-50"
        style={{
