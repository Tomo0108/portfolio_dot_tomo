...
// Component for individual article item with Three.js light
const ArticleItem = ({ article }: { article: ZennArticle }) => {
  ...
  return (
    <>
      ...
      <div className="relative z-10"> {/* Ensure content is above the light effect */}
