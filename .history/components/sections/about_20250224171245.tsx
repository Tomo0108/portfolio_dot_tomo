      ...
      <div className="container mx-auto px-4">
        <div className="bg-background rounded-xl shadow-sm py-16 px-6 md:px-12">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-8 relative min-h-[300px]">
              {skills.map((skill) => (
                <motion.div
                  key={skill.title}
                  initial={{ opacity: 0, y: 20 }}
                  layout
                  animate={{ 
                    opacity: hoveredIndex === null || hoveredIndex === skill.index ? 1 : 0,
                    y: 0,
                    x: hoveredIndex === skill.index ? -skill.index * 100 : 0,
                    zIndex: hoveredIndex === skill.index ? 10 : 0
                  }}
                  transition={{ 
                    duration: 0.4,
                    layout: { duration: 0.3 },
                  ...
                  className={cn(
                    ...
                    hoveredIndex !== null && hoveredIndex !== skill.index && "pointer-events-none opacity-0"
                  )}
                >
                  <SkillCard 
                    data={skill}
                    isHovered={hoveredIndex === skill.index}
