...
export function Gallery() {
  ...
  return (
    <section id="gallery" className="section-gallery py-24 space-y-12">
      ...
      <div className="w-full bg-muted/30">
        <div className="container mx-auto px-6 py-6">
          <div className="space-y-4">
            <div className="relative aspect-[16/6] max-w-[90vw] mx-auto">
              <div className="h-full grid grid-cols-5 gap-4 md:gap-8 items-center">
                <AnimatePresence initial={false} mode="popLayout">
                  {displayItems.map((item, index) => (
                    ...
                    >
                      <div 
                        className="group relative aspect-[3/4] bg-muted rounded-lg overflow-hidden cursor-pointer w-full"
