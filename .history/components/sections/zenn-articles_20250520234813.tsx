            ...
            <Card className="bg-card rounded-lg shadow-lg border border-border overflow-hidden">
              <CardContent className="p-6 bg-background">
                ...
                <div className="text-base md:text-sm text-foreground/90 leading-relaxed font-medium">
                  ...
                  他者からのフィードバックは嬉しいですし、何より、自分自身の学びを深めるためにもアウトプットを継続していきたいと考えています！
                </div>
              </CardContent>
            </Card>
          </div>
                ...
                {articles.map((article, index) => (
                  <CarouselItem key={article.id} className="pl-4 md:basis-1/2 lg:basis-1/3">
                    <motion.div
                      ...
                      className="h-full"
                    >
                      <Card className="h-full flex flex-col bg-card rounded-lg shadow-lg border border-border overflow-hidden group">
