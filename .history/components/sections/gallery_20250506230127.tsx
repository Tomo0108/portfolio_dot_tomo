    ...
    <section id="gallery" className="section-gallery py-16 grid-background">
      <div className="container mx-auto px-6">
        <div className="bg-background rounded-xl shadow-sm py-16 px-6 md:px-12">
          ...
          <div className="relative aspect-[4/3] sm:aspect-[16/5] max-w-[90vw] sm:max-w-[80vw] mx-auto">
            <div className="h-full grid grid-cols-5 gap-2 sm:gap-4 md:gap-8 items-center py-2">
