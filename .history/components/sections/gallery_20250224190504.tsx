    ...
    <section id="gallery" className="section-gallery py-24">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="relative flex justify-center items-center gap-4 min-h-[600px] py-8">
