        ...
        <div className="bg-background rounded-xl shadow-sm py-16 px-6 md:px-12">
          ...
          >
            ...
            <div className="max-w-4xl mx-auto mb-16">
              <div className="bg-card rounded-lg shadow-lg overflow-hidden p-6 md:p-8 border border-border">
                <div className="flex flex-col md:flex-row gap-8 items-center">
                  ...
                  <div className="flex-grow">
                    <div className="bg-background rounded-lg p-4 space-y-2 border border-border/50 transition-all duration-300 hover:bg-background/90">
