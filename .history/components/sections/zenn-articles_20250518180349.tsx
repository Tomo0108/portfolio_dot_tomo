        ...
        <div className="bg-background rounded-xl shadow-sm py-16 px-6 md:px-12">
          ...
          <div className="max-w-5xl mx-auto">
            <Carousel
              opts={{
                align: "start",
                loop: articles.length > 3, // 3件より多い場合にループを有効化
              }}
              className="w-full"
            >
                          ...
                          <div className="flex items-start justify-between gap-2">
                            <div className="flex items-center space-x-3 min-w-0">
                              ...
                              <div className="flex-grow min-w-0">
                                <CardTitle className="text-md lg:text-lg font-semibold line-clamp-3 leading-snug text-foreground group-hover:text-primary transition-colors h-[4.5em] sm:h-[3.9em]"> {/* 高さを調整 */}
