...
export function About() {
  return (
    <section id="about" className="section-about py-20 bg-secondary/10">
      <div className="container mx-auto px-4 bg-background rounded-xl shadow-sm">
        <motion.div
        ...
        >
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 items-center">
