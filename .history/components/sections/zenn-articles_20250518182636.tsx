          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row gap-8 items-stretch">
              ...
              <div className="md:w-1/3 w-full flex-shrink-0">
                <Card className="h-full bg-gradient-to-br from-background to-muted/60 border border-border/40 shadow-md rounded-xl p-6 flex flex-col justify-center items-start">
