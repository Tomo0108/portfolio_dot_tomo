          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            {skills.map((skill, index) => (
              <motion.div
                ...
                layout
                animate={{ 
                  opacity: !selectedSkill || selectedSkill === skill.title ? 1 : 0,
                  scale: !selectedSkill || selectedSkill === skill.title ? 1 : 0.8,
                  y: 0
                }}
                whileInView={{ y: 0 }}
                viewport={{ once: true }}
                ...
                className={cn(
                  ...
                  selectedSkill && selectedSkill !== skill.title && "pointer-events-none opacity-0"
                )}
              >
                <SkillCard 
                  data={skill}
                  isSelected={selectedSkill === skill.title}
                  onSelect={() => setSelectedSkill(skill.title)}
