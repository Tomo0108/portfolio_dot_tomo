...
export function Gallery() {
  ...
  return (
    <section id="gallery" className="section-gallery section-grid">
            ...
            <CarouselContent>
              {allItems.map((item, index) => (
                <CarouselItem key={item.id} className="md:basis-1/2 lg:basis-1/3">
                  <div className="p-1">
                    <div 
                      className="group relative aspect-[3/4] sm:aspect-square md:aspect-[3/4] bg-card rounded-lg shadow-lg border border-border overflow-hidden cursor-pointer w-full"
