...
export function Hero() {
  return (
    <section className="section-hero min-h-screen flex items-center justify-center relative bg-background">
      <div className="relative w-full max-w-[1000px] aspect-square mx-auto group">
        <div className="absolute inset-0 flex items-center justify-center z-10">
          <motion.div 
            className="text-center space-y-8 transition-opacity duration-300 group-hover:opacity-50"
