                ...
                >
                  <Accordion type="single" collapsible>
                    <AccordionItem value={example.id} className="border-none">
                      <AccordionTrigger className="hover:no-underline pt-4 px-4 pb-3">
                        <div className="w-full flex flex-col items-start">
                          <h5 className="font-japanese font-bold bg-white/90 dark:bg-white/90 text-black px-3 py-2 rounded-md text-lg shadow-sm">
                            {example.title}
                          </h5>
                          <p className="text-base text-foreground/90 leading-relaxed mt-3 pl-1">{example.description}</p>
                        </div>
                      </AccordionTrigger>
                      <AccordionContent>
