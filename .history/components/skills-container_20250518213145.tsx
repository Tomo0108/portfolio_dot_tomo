                              ...
                              <div className="pt-2 pb-4">
                                <Table className="border-collapse border border-border">
                                  <TableHeader className="bg-primary">
                                    <TableRow>
                                      <TableHead className="w-[70%] text-primary-foreground border-r border-border">自動化項目</TableHead>
                                      <TableHead className="text-right text-primary-foreground">削減時間</TableHead>
                                    </TableRow>
                                  </TableHeader>
                                  <TableBody>
                                    {example.achievements.map((achievement, index) => (
                                      <TableRow key={index} className="hover:bg-muted/50 border-b border-border">
                                        <TableCell className="font-medium py-3 px-4 border-r border-border">{achievement.item}</TableCell>
                                        <TableCell className="text-right py-3 px-4 text-accent-foreground font-semibold">{achievement.reductionTime}</TableCell>
                                      </TableRow>
                                    ))}
                                  </TableBody>
                                </Table>
