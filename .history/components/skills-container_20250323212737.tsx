                ...
                >
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value={example.id} className="border-none">
                      <AccordionTrigger className="p-0 hover:no-underline flex justify-between items-start w-full">
                        <div className="space-y-3 w-full">
                          <h5 className="font-japanese font-bold bg-white/90 dark:bg-white/90 text-black px-4 py-2.5 rounded-md text-lg w-full shadow-sm">
                            {example.title}
                          </h5>
