...
export function SkillsContainer() {
  ...
  return (
    <div className="relative bg-background rounded-xl p-0 md:p-0 overflow-hidden">
      <div className="flex flex-wrap md:flex-nowrap gap-3 mb-10 px-6 md:px-8 pt-6 md:pt-8">
        {skills.map((skill, index) => {
          ...
          return (
            <button
              ...
              className={cn(
                "p-4 rounded-lg text-left w-full md:w-auto md:flex-1 border border-border",
                "transition-all duration-300 ease-in-out",
                selectedIndex === index
                  ? "bg-primary text-primary-foreground shadow-lg"
                  : "bg-muted hover:bg-muted/90 dark:hover:bg-muted/70"
              )}
            >
              <div className="flex items-center gap-2 mb-1">
                <Icon className={cn("h-5 w-5", selectedIndex === index ? "text-primary-foreground" : "text-primary")} />
            ...
            <div className="grid gap-4">
              {currentSkill.examples.map((example) => (
                example.id.startsWith('strategy') ? (
                  <div
                    key={example.id}
                    className="bg-card rounded-lg shadow-lg overflow-hidden transition-all duration-300"
                  >
