              ...
              <div className="mt-8 space-y-6">
                <div>
                  <h1 className="text-3xl font-bold font-heading mb-4">
                    <span className="bg-white dark:bg-white px-3 py-1.5 rounded inline-block text-black">
                      <span className="block text-sm mb-1 text-black/70">
                        {
                          item.title === "Nahida" ? "ナヒーダ" :
                          item.title === "Nahida II" ? "ナヒーダ" :
                          item.title === "Killua" ? "キルア" :
                          null
                        }
                      </span>
                      {item.title}
                ...
                <div className="bg-white/80 dark:bg-white/90 backdrop-blur rounded-xl p-6">
                  <div className="prose dark:prose-invert max-w-none">
                    <p className="text-black/70 dark:text-black/80 text-lg leading-relaxed">{item.details.fullDescription}</p>
                  </div>
                </div>

                <div className="bg-white/80 dark:bg-white/90 backdrop-blur rounded-xl p-6">
                  <h2 className="text-xl font-bold font-heading mb-4 text-black/90">Tools</h2>
                  <div className="flex flex-wrap gap-2">
                    {item.details.technologies.map((tech) => (
                      <span
                        key={tech}
                        className="px-3 py-1 bg-black/5 rounded-full text-sm border border-black/10"
                      >
                        {tech}
                      </span>
                    ))}
