...
import { ChevronLeft, Circle, Pencil, Palette, Image as ImageIcon, ZoomIn } from 'lucide-react';
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <div className="relative aspect-[4/3] w-full bg-muted rounded-lg overflow-hidden">
                  ...
                  />
                  <div className="absolute bottom-2 right-2 bg-white/80 rounded px-3 py-1 text-xs text-primary font-bold pointer-events-none select-none">
                    {isHighRes ? "高画質表示中（クリックで戻す）" : "クリックで高画質"}
                  </div>
                </div>
