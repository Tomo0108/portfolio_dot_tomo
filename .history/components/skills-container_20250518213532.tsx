                              ...
                              <div className="pt-2 pb-4">
                                <Table className="border-collapse border border-border">
                                  <TableHeader className="bg-primary">
                                    <TableRow>
                                      <TableHead className="w-[70%] px-4 py-3 text-primary-foreground">自動化項目</TableHead>
                                      <TableHead className="text-right px-4 py-3 text-primary-foreground">削減時間</TableHead>
                                    </TableRow>
                                  </TableHeader>
                                  <TableBody>
                                    {example.achievements.map((achievement, index) => (
                                      <TableRow key={index} className="hover:bg-muted/50 border-b border-border">
                                        <TableCell className="font-medium p-3 border border-border">{achievement.item}</TableCell>
                                        <TableCell className="text-right p-3 border border-border text-primary font-semibold">{achievement.reductionTime}</TableCell>
                                      </TableRow>
                                    ))}
                                  </TableBody>
                                </Table>
