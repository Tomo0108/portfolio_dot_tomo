...
export const skills: Skill[] = [
  {
    ...
    examples: [
      ...
      },
      {
        ...
        description: "会社の特徴をRPGの世界観で表現し、印象に残る企画を実現",
        longDescription: "コンセプトを反映したRPG風デザインの会社案内を制作。ゲーム性を取り入れることで、楽しみながら会社の情報を理解できる仕組みを構築しました。"
      },
      {
        id: "tech-4",
        title: "社内勉強会の企画・発表資料を制作",
        description: "技術力向上のための勉強会を企画し、わかりやすい資料を作成",
        longDescription: "社内勉強会の企画から資料作成まで担当。技術的な内容を初心者にもわかりやすく説明するため、視覚的な要素を多く取り入れた資料を作成しました。"
      }
    ]
  },
  {
